...
class JwtBearer implements GrantTypeInterface, ClientAssertionTypeInterface
{
     ...
     *
     * @param OAuth2\Storage\JWTBearerInterface|JwtBearerInterface $storage A valid storage interfaces that implements storage hooks for the JWT bearer grant type.
