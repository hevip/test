...
class ObjectProphecy implements ProphecyInterface
{
    ...
    /**
     * Forces double to implement specific interfaces.
     *
     ...
     * @return object
     *
     * @throws \Prophecy\Exception\Prophecy\ObjectProphecyException If double doesn't implement needed interfaces
     */
