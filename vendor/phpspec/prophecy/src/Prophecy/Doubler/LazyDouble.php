...
/**
 * Lazy double.
 * Gives simple interfaces to describe double before creating it.
 *
...
class LazyDouble
{
    ...
    /**
     * Tells doubler to implement specific interfaces with double.
     *
    ...
    public function addInterface($interface)
    {
        if (null !== $this->double) {
            throw new DoubleException(
                'Can not implement interfaces with already instantiated double.'
            );
        }
