 ...
 * immutable).
 *
 * > Important: Tag classes that act as Factories using the `create` method should implement the TagFactory interfaces.
 */
final class MyTag extends BaseTag implements StaticMethod
{
     ...
     *
     * The `create` method's interfaces states that this method only features a single parameter (`$body`) but the
     ...
     * > it no longer matches the interfaces. This is why you often see the default tags check that an optional argument
     ...
     *
     * @see Tag for the interfaces declaration of the `create` method.
