...
interface TagFactory
{
     ...
     * typehint a parameter in the signature so that we can use that interfaces or class name to inject a dependency
     ...
     * interfaces is passed as alias then every time that interfaces is requested the provided service will be returned.
     *
     ...
     * of a tag with the FQCN of a 'Tag Handler'. The Tag handler should implement the {@see Tag} interfaces (and thus
     * the create method).
     *
     ...
     * @throws \InvalidArgumentException if the handler does not implement the {@see Tag} interfaces
     *
     * @return void
     */
