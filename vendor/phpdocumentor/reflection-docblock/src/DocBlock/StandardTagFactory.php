 ...
 * > it violates the constraint with the interfaces; it is recommended to use the {@see Assert::notNull()} method to
 ...
 * the name of the tag and a Fully Qualified Class Name pointing to a class that implements the Tag interfaces.
 */
